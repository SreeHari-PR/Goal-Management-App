...
import {
  editUser,
  // deleteUser, // Add the deleteUser action
  getAllUsers,
  reset,
  UserBlock,
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              ...
              <th style={{ borderBottom: "1px solid #ddd", padding: "10px 0", textAlign: "left" }}>Action</th> {/* Add this header for the delete button */}
            </tr>
          </thead>
          <tbody>
            {users.map((user, index) => (
              <tr key={index}>
                ...
                <td className="action-buttons" style={{ borderBottom: "1px solid #ddd", padding: "10px 0" }}>
                  <div className="table-button" style={{ display: "flex" }}>
                    <button
                ...
                <td className="action-buttons" style={{ borderBottom: "1px solid #ddd", padding: "10px 0" }}> {/* Add this cell for the delete button */}
                  {/* <button
                    onClick={() => handleDelete(user._id)}
                    className="btn"
                    style={{ padding: "6px 10px", borderRadius: "5px", background: "#f44336", color: "#fff", cursor: "pointer" }}
                  >
                    Delete
                  </button> */}
                </td>
